...
if len(sys.argv)!=12 :
  sys.exit("Usage 04_smd.py temperature in.chk out.csv out.dat out.pdb out.dcd resnumber atomname distance hbond(1/0) startdist")
...
resnumber=sys.argv[7]
atomname=sys.argv[8]
distance=sys.argv[9]
hbond=sys.argv[10]
startdist=float(sys.argv[11])
